...
fun ConclusionPage() {
    Column(modifier = Modifier) {
        ...
        Text(text = "その他のキーワード", style = Typography.headlineLarge)
        Text(text = "・Compose-BOM(Bill of Materials)", style = Typography.headlineMedium)
        Text(text = "バージョン管理が煩雑なComposeを扱いやすくする仕組み", style = Typography.headlineSmall)
    }
}
